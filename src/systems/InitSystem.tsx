...
import { IoAccessibility, IoAlarm, IoAlert, IoAnalytics, IoApps, IoBeaker, IoPaperPlane } from 'react-icons/io5';
...
const InitSystem = () => {
  ...
  useEffect(() => {
    ...
    blockEntity3.addComponent(new OrderFacet({ order: 1 }));
    ...
    blockEntity4.addComponent(new OrderFacet({ order: 2 }));
    ...
    blockEntity5.addComponent(new OrderFacet({ order: 3 }));
    ...
    blockEntity2.addComponent(new OrderFacet({ order: 4 }));
    ...
    blockEntity6.addComponent(new OrderFacet({ order: 5 }));
    ...
    blockEntity7.addComponent(new OrderFacet({ order: 6 }));
    ...
    blockEntity100.addComponent(new OrderFacet({ order: 1 }));
    ...
    blockEntity8.addComponent(new OrderFacet({ order: 7 }))
    ...
    blockEntity9.addComponent(new OrderFacet({ order: 8 }));
    ...
    blockEntity11.addComponent(new OrderFacet({ order: 9 }));
    ...
    blockEntity10.addComponent(new OrderFacet({ order: 10 }));
    ...
    blockEntity10.addComponent(new IconFacet({ icon: <IoBeaker/> }));
    ...
    blockEntity12.addComponent(new OrderFacet({ order: 11 }));
    ...
    blockEntity12.addComponent(new IconFacet({ icon: <IoApps/> }));
    ...
    blockEntity13.addComponent(new OrderFacet({ order: 12 }));
    ...
    blockEntity14.addComponent(new OrderFacet({ order: 13 }));
    ...
    blockEntity15.addComponent(new OrderFacet({ order: 14 }));
    ...
    blockEntity16.addComponent(new OrderFacet({ order: 15 }));
